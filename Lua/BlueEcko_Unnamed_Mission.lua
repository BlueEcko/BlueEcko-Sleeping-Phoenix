...
local OSPPhase1 = { 
 [1] = {       
    TargetName = "RED SAM SA-8-OCHAMCHIRA",
    TargetStatic = false,
  ...
  [2] = {       
    ...
    TargetStatic = true,
    TargetBriefing = "Destroy the Communications Tower Near Enguri Dam\nGrid KN53",
    TargetAuftrag = AUFTRAG.Type.BOMBING,
  },
  [3] = {       
    TargetName = "Saberio - Tent 1",
    TargetStatic = true,
    TargetBriefing = "Destroy the Field Command Post located at Saberio\nGrid GH32",
    TargetAuftrag = AUFTRAG.Type.BOMBING,
  },
  [4] = {       
  ...
  [14] = {        
    ...
    TargetStatic = true,
    TargetBriefing = "Destroy the Military Command HQ at Zeni\nGrid GH21",
    TargetAuftrag = AUFTRAG.Type.BOMBING,
  },
  [15] = {        
...
--MANTIS
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
local RedMantis = MANTIS:New("Red MANTIS","RED SAM","RED EWR",nil,"red",true,nil,false,30)

RedMantis:__Start(10)
local BlueMantis = MANTIS:New("Blue MANTIS","BLUE SAM","BLUE EWR",nil,"blue",true,nil,false,30)
...
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
local BlueSqd97=SQUADRON:New("Arco 1-1", 99, "Arco 1-1") --Ops.Squadron#SQUADRON
BlueSqd97:AddMissionCapability({AUFTRAG.Type.RECOVERYTANKER}, 100)
BlueSqd97:SetFuelLowRefuel(true)
BlueSqd97:SetFuelLowThreshold(0.1)
BlueSqd97:SetRadio(251)
BlueSqd97:SetCallsign(CALLSIGN.Tanker.Arco,1)
BlueSqd97:AddTacanChannel(51,51)
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
...
BlueAirWing1:NewPayload("USAF AWACS Detectionl", 99, {AUFTRAG.Type.AWACS}, 99)
...
BlueRooseveltAirwing:AddSquadron(BlueSqd97)
...
--RED AUFTRAG SETUP
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
BlueRESCUEHELO = AUFTRAG:NewRESCUEHELO("CVN-71 Theodore Roosevelt")
BlueRECOVERYTANKER = AUFTRAG:NewRECOVERYTANKER("CVN-71 Theodore Roosevelt")
...
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
local AirbossAbe = AIRBOSS:New("CVN-71 Theodore Roosevelt","Roosevelt")
AirbossAbe:SetTACAN(71, "X", "ROS")
AirbossAbe:SetICLS(1, "ROS")
AirbossAbe:SetSoundfilesFolder("Airboss Soundfiles/")
AirbossAbe:SetRadioRelayLSO("RooseveltRescueHelo")
AirbossAbe:SetLSORadio("325", "AM")
AirbossAbe:SetRadioRelayMarshal("RooseveltRescueHelo")
AirbossAbe:SetMarshalRadio("320", "AM")
AirbossAbe:SetMenuRecovery(30, 20, false)
AirbossAbe:SetDespawnOnEngineShutdown()
AirbossAbe:Load(Path)
AirbossAbe:SetAutoSave(Path)
AirbossAbe:SetTrapSheet()

----------------------------------------------------------------------------------------------------------------------------------------------------
local AirbossForestal = AIRBOSS:New("CVN-74 John C. Stennis","Stennis")
AirbossForestal:SetTACAN(74, "X", "STN")
AirbossForestal:SetICLS(4, "STN")
AirbossForestal:SetSoundfilesFolder("Airboss Soundfiles/")
AirbossForestal:SetRadioRelayLSO("RooseveltRescueHelo")
AirbossForestal:SetLSORadio("315", "AM")
AirbossForestal:SetRadioRelayMarshal("RooseveltRescueHelo")
AirbossForestal:SetMarshalRadio("310", "AM")
AirbossForestal:SetMenuRecovery(30, 20, false)
AirbossForestal:SetDespawnOnEngineShutdown()
AirbossForestal:Load(Path)
AirbossForestal:SetAutoSave(Path)
AirbossForestal:SetTrapSheet()
